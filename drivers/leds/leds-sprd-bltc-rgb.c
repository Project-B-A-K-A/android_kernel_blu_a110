...
#define BLTC_R_PRESCL			0x0014//0x0004
#define BLTC_G_PRESCL			0x0004//0x0014
#define BLTC_B_PRESCL			0x0024//0x0024
...
#define BLTC_R_TYPE				(0x1<<5)//(0x1<<1)
#define BLTC_G_TYPE				(0x1<<1)//(0x1<<5)
#define BLTC_B_TYPE				(0x1<<9)//(0x1<<9)
#define BLTC_R_RUN				(0x1<<4)//(0x1<<0)
#define BLTC_G_RUN				(0x1<<0)//(0x1<<4)
#define BLTC_B_RUN				(0x1<<8)//(0x1<<8)
...
static void sprd_leds_bltc_rgb_enable(struct sprd_leds_bltc_rgb *brgb)
{
        ...
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_R]) == 0) {
                sci_adi_set(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_R_TYPE|BLTC_R_RUN);
        ...
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_G]) == 0) {
                sci_adi_set(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_G_TYPE|BLTC_G_RUN);
        ...
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_B]) == 0) {
                sci_adi_set(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_B_TYPE|BLTC_B_RUN);
        ...
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_R_BL]) == 0 || \
            ...
            strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_B_BL]) == 0) {
                ...
                if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_R_BL]) == 0) {
						...
						sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_R_TYPE|BLTC_R_RUN);
                }
                if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_G_BL]) == 0) {
						...
						sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_G_TYPE|BLTC_G_RUN);
                }
                if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_B_BL]) == 0) {
						...
						sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_B_TYPE|BLTC_B_RUN);
                }
...
static void sprd_leds_bltc_rgb_disable(struct sprd_leds_bltc_rgb *brgb)
{
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_R]) == 0 || \
            strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_R_BL]) == 0) {
                sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_R_RUN);
        }
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_G]) == 0 || \
            strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_G_BL]) == 0) {
                sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_G_RUN);
        }
        if(strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_B]) == 0 || \
            strcmp(brgb->cdev.name,sprd_leds_rgb_name[SPRD_LED_TYPE_B_BL]) == 0) {
                sci_adi_clr(brgb->sprd_bltc_base_addr + BLTC_CTRL, BLTC_B_RUN);
        }
