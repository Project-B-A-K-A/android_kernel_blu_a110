...
{										
    printk("geroge  show_chipinfo_value start \n");
    ...
    sprintf(FlashInfo, "%4x%4x%4x%4x", card->raw_cid[0],
    	                                                   ...
    	                                                   card->raw_cid[2],
    	                                                   card->raw_cid[3]);
    printk("geroge FlashID is %s\n",FlashInfo);
    for(recordCount = 0; recordCount < num_of_emi_records; recordCount++)
    {
        printk("geroge flash_info_settings[recordCount].id of length is %d\n",(int)strlen(flash_info_settings[recordCount].id));
        printk("geroge flash_info_settings[recordCount].id  is %s\n",flash_info_settings[recordCount].id);
        printk("geroge flash_info_settings[recordCount].vendorName is %s\n",flash_info_settings[recordCount].vendorName);
		printk("geroge flash_info_settings[recordCount].modelName is %s\n",flash_info_settings[recordCount].modelName);
        printk("geroge flash_info_settings[recordCount].romSize is %s\n",flash_info_settings[recordCount].romSize);
        printk("geroge flash_info_settings[recordCount].ramSize is %s\n",flash_info_settings[recordCount].ramSize);
        ...
        {
            sprintf(tempID,"%s_%s_%s+%s",flash_info_settings[recordCount].vendorName,flash_info_settings[recordCount].modelName,
				                         flash_info_settings[recordCount].romSize,flash_info_settings[recordCount].ramSize);
	     break;
        }
    }
    printk("geroge  show_chipinfo_value end\n");
