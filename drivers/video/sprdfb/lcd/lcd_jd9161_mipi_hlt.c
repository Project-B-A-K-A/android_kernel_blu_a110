...
static LCM_Init_Code init_data[] = {
	...
	{LCM_SEND(5),{3,0,0xB3,0x00,0xbf}},
	{LCM_SEND(5),{3,0,0xB4,0x00,0xaf}},
	...
	{LCM_SEND(41),{39,0,0xC8,0x7e,0x6c,0x52,0x3f,0x35,0x23,0x27,0x12,0x2e,0x31,0x35,0x59,0x4e,0x60,0x5a,0x62,0x5d,0x57,0x4E,
	...
	{LCM_SEND(19),{17,0,0xD6,0x1F,0x1E,0x17,0x07,0x09,0x0B,0x05,0x07,0x03,0x01,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F}},
...
static uint32_t jd9161_readid(struct panel_spec *self)
{
	...
	for(j = 0; j < 4; j++){
		...
		printk("lcd_jd9161_mipi hlt read id 0x04 value is 0x%x, 0x%x, 0x%x!\n", read_data[0], read_data[1], read_data[2]);
...
struct panel_cfg lcd_jd9161_mipi = {
	...
	.lcd_id = 0x916100,
	.lcd_name = "jd9161_wvga_dsi_vdo_hsd_hlt",
