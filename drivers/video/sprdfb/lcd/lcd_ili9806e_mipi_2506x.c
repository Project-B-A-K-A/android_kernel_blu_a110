...
{LCM_SEND(2),{0x31,0x02}},// C Inversion
{LCM_SEND(2),{0x40,0x10}},// BT 				 
{LCM_SEND(2),{0x41,0x33}},// DVDDH DVDDL clamp 
{LCM_SEND(2),{0x42,0x02}},// VGH/VGL 
{LCM_SEND(2),{0x43,0x09}},// VGH/VGL  
{LCM_SEND(2),{0x44,0x03}},// VGL_CLAMP OFF 
{LCM_SEND(2),{0x45,0x05}},// LOW DETEC 
{LCM_SEND(2),{0x48,0x30}},// VCOM SET NVM OR REG		     
	
{LCM_SEND(2),{0x50,0x81}},// VGMP				    
{LCM_SEND(2),{0x51,0x81}},// VGMN				     
{LCM_SEND(2),{0x52,0x00}},// Flicker 
{LCM_SEND(2),{0x53,0x51}},// Flicker	 
...
{LCM_SEND(2),{0xA1,0x06}},// Gamma 251    
{LCM_SEND(2),{0xA2,0x13}},// Gamma 247   
{LCM_SEND(2),{0xA3,0x14}},// Gamma 239   
{LCM_SEND(2),{0xA4,0x0E}},// Gamma 231  
{LCM_SEND(2),{0xA5,0x1F}},// Gamma 203  
{LCM_SEND(2),{0xA6,0x0C}},// Gamma 175  
{LCM_SEND(2),{0xA7,0x0B}},// Gamma 147   
{LCM_SEND(2),{0xA8,0x03}},// Gamma 108  
{LCM_SEND(2),{0xA9,0x0a}},// Gamma 80  
{LCM_SEND(2),{0xAA,0x01}},// Gamma 52  
{LCM_SEND(2),{0xAB,0x08}},// Gamma 24   
{LCM_SEND(2),{0xAC,0x0C}},// Gamma 16    
{LCM_SEND(2),{0xAD,0x35}},// Gamma 8	
{LCM_SEND(2),{0xAE,0x34}},// Gamma 4	    
{LCM_SEND(2),{0xAF,0x00}},// Gamma 0	 
	
{LCM_SEND(2),{0xC0,0x00}},// Gamma 255    
{LCM_SEND(2),{0xC1,0x07}},// Gamma 251   
{LCM_SEND(2),{0xC2,0x15}},// Gamma 247  
{LCM_SEND(2),{0xC3,0x12}},// Gamma 239  
{LCM_SEND(2),{0xC4,0x0B}},// Gamma 231 
{LCM_SEND(2),{0xC5,0x1B}},// Gamma 203  
{LCM_SEND(2),{0xC6,0x08}},// Gamma 175   
{LCM_SEND(2),{0xC7,0x07}},// Gamma 147   
{LCM_SEND(2),{0xC8,0x03}},// Gamma 108   
{LCM_SEND(2),{0xC9,0x07}},// Gamma 80   
{LCM_SEND(2),{0xCA,0x07}},// Gamma 52   
{LCM_SEND(2),{0xCB,0x02}},// Gamma 24    
{LCM_SEND(2),{0xCC,0x0A}},// Gamma 16    
{LCM_SEND(2),{0xCD,0x1B}},// Gamma 8	 
{LCM_SEND(2),{0xCE,0x15}},// Gamma 4	  
{LCM_SEND(2),{0xCF,0x00}},// Gamma 0	  
...
struct panel_cfg lcd_ili9806e_mipi = {
	...
	.lcd_id = 0x04,
	.lcd_name = "lcd_ili9806e_mipi_txd_2506x",
