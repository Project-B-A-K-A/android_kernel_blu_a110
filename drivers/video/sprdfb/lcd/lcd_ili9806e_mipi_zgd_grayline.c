...
{LCM_SEND(2),{0x50,0X50}},
{LCM_SEND(2),{0x51,0X50}},
{LCM_SEND(2),{0x60,0X17}},
{LCM_SEND(2),{0x61,0X00}},
{LCM_SEND(2),{0x62,0X07}},
{LCM_SEND(2),{0x63,0X00}},
{LCM_SEND(2),{0x40,0X15}},
{LCM_SEND(2),{0x41,0X33}},
{LCM_SEND(2),{0x42,0X03}},
{LCM_SEND(2),{0x43,0X0C}},
{LCM_SEND(2),{0x44,0X06}},
{LCM_SEND(2),{0x52,0X00}},
{LCM_SEND(2),{0x53,0X48}},
{LCM_SEND(2),{0x57,0X50}},
{LCM_SEND(8), {6, 0,0xFF,0xFF,0x98,0x06,0x04,0x01}},// Change to Page 1
{LCM_SEND(2),{0xA0,0X00}},
{LCM_SEND(2),{0xA1,0X02}},
{LCM_SEND(2),{0xA2,0X09}},  //0X1E
{LCM_SEND(2),{0xA3,0X10}},
{LCM_SEND(2),{0xA4,0X0A}},
{LCM_SEND(2),{0xA5,0X1D}},
{LCM_SEND(2),{0xA6,0X0B}},
{LCM_SEND(2),{0xA7,0X0B}},
{LCM_SEND(2),{0xA8,0X01}},
{LCM_SEND(2),{0xA9,0X06}},
{LCM_SEND(2),{0xAA,0X04}},
{LCM_SEND(2),{0xAB,0X04}},
{LCM_SEND(2),{0xAC,0X0B}},
{LCM_SEND(2),{0xAD,0X34}},  //0X2F
{LCM_SEND(2),{0xAE,0X2F}},
{LCM_SEND(2),{0xAF,0X00}},
{LCM_SEND(2),{0xC0,0X00}},
{LCM_SEND(2),{0xC1,0X00}},
{LCM_SEND(2),{0xC2,0X05}}, //0X18
{LCM_SEND(2),{0xC3,0X0D}},
{LCM_SEND(2),{0xC4,0X08}},
{LCM_SEND(2),{0xC5,0X15}},
{LCM_SEND(2),{0xC6,0X08}},
{LCM_SEND(2),{0xC7,0X07}},
{LCM_SEND(2),{0xC8,0X05}},
{LCM_SEND(2),{0xC9,0X0A}},
{LCM_SEND(2),{0xCA,0X07}},
{LCM_SEND(2),{0xCB,0X03}},
{LCM_SEND(2),{0xCC,0X0A}},
{LCM_SEND(2),{0xCD,0X26}}, //0X1E
{LCM_SEND(2),{0xCE,0X20}},
...
{LCM_SEND(2),{0x0C,0X20}},
{LCM_SEND(2),{0x0D,0X20}},
{LCM_SEND(2),{0x0E,0X09}},
{LCM_SEND(2),{0x0F,0X00}},
{LCM_SEND(2),{0x10,0XFF}},
{LCM_SEND(2),{0x11,0XE0}},
...
{LCM_SEND(2),{0x37,0XDB}},
{LCM_SEND(2),{0x38,0XCC}},
{LCM_SEND(2),{0x39,0XBD}},
...
static LCM_Force_Cmd_Code rd_prep_code_page0[]={
	{0x39, {LCM_SEND(8), {0x6, 0, 0xFF, 0xFF, 0x98, 0x06,0x04,0x00}}},
	{0x37, {LCM_SEND(2), {0x3, 0}}},
};
...
static uint32_t ili9806e_readid(struct panel_spec *self)
{
	...
	for(j = 0; j < 4; j++){
		...
		printk("lcd_ili9806e_mipi read id 0xc5 value is 0x%x, 0x%x, 0x%x!\n", read_data[0], read_data[1], read_data[2]);
                           ...
                           rd_prepare= rd_prep_code_page0;
		for(i = 0; i < ARRAY_SIZE(rd_prep_code_page0); i++){
			tag = (rd_prepare->real_cmd_code.tag >> 24);
			if(tag & LCM_TAG_SEND){
				mipi_force_write(rd_prepare->datatype, rd_prepare->real_cmd_code.data, (rd_prepare->real_cmd_code.tag & LCM_TAG_MASK));
			}else if(tag & LCM_TAG_SLEEP){
			...
			rd_prepare++;
                          	...
                          	read_rtn = mipi_force_read(0xDA, 1,(uint8_t *)read_data_p0);
		printk("lcd_ili9806e_mipi read code 0xDA value is 0x%x \n", read_data_p0[0]);

		if((0x04 == read_data[0])){
                                if(0xA1 == read_data_p0[0]){
         		     printk("lcd_ili9806e_mipi read id success!\n");
         		     mipi_eotp_set(1,1);
         		     return 0x04;}
                                else{
                                printk("lcd_ili9806e_mipi read code failed!\n");        
                                mipi_eotp_set(1,1);
                                return 0x0;}
		}
	}
...
struct panel_spec lcd_ili9806e_mipi_spec_grayline = {
...
struct panel_cfg lcd_ili9806e_mipi_grayline = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x9806A1,
	.lcd_name = "lcd_ili9806e_mipi_grayline",
	.panel = &lcd_ili9806e_mipi_spec_grayline,
};

static int __init lcd_ili9806e_mipi_init(void)
{
	return sprdfb_panel_register(&lcd_ili9806e_mipi_grayline);
}
