...
static LCM_Init_Code init_data[] = {
	...
	{LCM_SEND(5),{3,0,0xB3,0x00,0x94}},
	{LCM_SEND(5),{3,0,0xB4,0x00,0x94}},
	...
	{LCM_SEND(41),{39,0,0xC8,0x44,0x43,0x3F,0x38,0x39,0x2B,0x2f,0x1A,0x36,0x38,0x3b,0x5F,0x53,0x65,0x5F,0x68,0x63,0x5E,0x58,0x44,
				0x43,0x3F,0x38,0x39,0x2B,0x2f,0x1A,0x36,0x38,0x3b,0x5F,0x53,0x65,0x5F,0x68,0x63,0x5E,0x58}},
...
static uint32_t jd9161_readpowermode(struct panel_spec *self)
{
	...
	//LCD_PRINT("lcd_jd9161_mipi read power mode!\n");
	mipi_eotp_set(0,1);
	...
	for(j = 0; j < 4; j++){
		...
		if((0x9c == read_data[0])  && (0 == read_rtn)){
			//LCD_PRINT("lcd_jd9161_mipi read power mode success!\n");
			mipi_eotp_set(1,1);
			return 0x9c;
		}
	}
	...
	//LCD_PRINT("lcd_jd9161_mipi read power mode fail!0x0A value is 0x%x! , read result(%d)\n", read_data[0], read_rtn);
	return 0x0;
}
...
static uint32_t jd9161_check_esd(struct panel_spec *self)
{
	...
	if(power_mode == 0x9c){
		//LCD_PRINT("jd9161_check_esd OK!\n");
		return 1;
	}else{
		LCD_PRINT("jd9161_check_esd fail!(0x%x)\n", power_mode);
		return 0;
	}
}
...
static struct info_mipi lcd_jd9161_mipi_info = {
	...
	.lan_number = 2,
	.phy_feq = 481*1000, //500->10MHz,400->8M in lp mode  450
...
struct panel_spec lcd_jd9161_mipi_spec_txd = {
...
struct panel_cfg lcd_jd9161_mipi_txd = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x9161a1,
	.lcd_name = "jd9161_wvga_dsi_vdo_hsd_txd",
	.panel = &lcd_jd9161_mipi_spec_txd,
};

static int __init lcd_jd9161_mipi_init(void)
{
	return sprdfb_panel_register(&lcd_jd9161_mipi_txd);
}
