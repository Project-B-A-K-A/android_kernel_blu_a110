...
#define MMC3524X_IOC_SET_DELAY        	    _IOW(MSENSOR, 0x29, short)
#define MSENSOR_IOCTL_MSENSOR_ENABLE             _IOW(MSENSOR, 0x2a, int[12])
#define MSENSOR_IOCTL_OSENSOR_ENABLE             _IOW(MSENSOR, 0x2b, int[12])
